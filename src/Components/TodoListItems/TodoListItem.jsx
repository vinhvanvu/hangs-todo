    ...
    return (
        <div className='todo-list-item'>
            <div className='todo-list-item-right'>
                <Checkbox className='checkbox' onCheck={props.onCheck} checked={props.checked} todoid={props.todoid}/>
            ...
            <FontAwesomeIcon className='trashcan' icon={faTrashCan} onClick={() => props.onDelete(props.todoid)}
                style={{
